...
A premium, modern, and haptics-rich score tracker for card games. Designed specifically for Italian card game classics (such as Scopa, Briscola, Bisca, and Ciccopaolo), **ScoreKeeper** features a stunning dark-mode interface, fluid animations, and custom haptic feedback profiles to elevate your tabletop game nights.
...
- **⚡ Tactile Haptics:** Custom-engineered haptic feedback utilizing `UIImpactFeedbackGenerator` and `UINotificationFeedbackGenerator`. Experience subtle ticks on adjustments, a success feedback on round wins, and a custom **Tap-Tap-Tap-BOOM** sequence upon winning a game.
...
| **Ciccopaolo** | Advanced Scopa variant | Features specialized score sheets with support for best-of-3 tournament-style rounds. |
...
- **Burraco & Scala Quaranta:** Support for meld-based card tracking, wildcards, and clean/dirty burraco calculations.
